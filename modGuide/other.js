function basicComplete() {
	...
	document.getElementById("pops").innerHTML += `<div class="card">
		<div class="card-content">
			...
			<div class="buttons">
				<a class="button is-link" onclick="complete()">Yes</a>
...
function offlineMode() {
	...
	<div class="card">
		<div class="card-content">
			<div class="media">
				<div class="media-content">
					<p class="title is-4">While many mods do work in Online Mode, you should try playing in Offline Mode to see if it makes a difference.</p>
				</div>
			</div>
		</div>
	</div>`
...
function pleaseRemovecomplete() {
	...
	<div class="card">
		<div class="card-content">
			<div class="media">
				<div class="media-content">
					<p class="title is-4">Please remove it and try again.</p>
				</div>
			</div>
		</div>
	</div>`
...
function complete() {
	...
	<div class="card">
		<div class="card-content">
			<div class="media">
				<div class="media-content">
					<p class="title is-4">Everything should work. Contact the mod author if the mod continues to not work.</p>
				</div>
			</div>
		</div>
	</div>`
